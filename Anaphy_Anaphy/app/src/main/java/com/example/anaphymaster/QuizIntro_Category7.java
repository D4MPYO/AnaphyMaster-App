...
public class QuizIntro_Category7 extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r_practice_quiz_7);
        ...
        if (takeExamButton != null) {
            ...
            takeExamButton.setOnClickListener(v -> {
                Intent intent = new Intent(QuizIntro_Category7.this, Prac_7_Nervous.class);
