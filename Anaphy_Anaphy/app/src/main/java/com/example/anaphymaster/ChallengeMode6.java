...
public class ChallengeMode6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.challenge_mode6);
        ...
        rationaleIcon.setOnClickListener(v -> {
            if (hasAnswered) {
                ...
                Toast.makeText(ChallengeMode6.this, "This feature is available after submitting an answer.", Toast.LENGTH_LONG).show();
            }
        });

        restartIcon.setOnClickListener(v -> {
            new AlertDialog.Builder(ChallengeMode6.this)
            ...
            if (currentIndex < maxQuestions - 1) {
                ...
                new AlertDialog.Builder(ChallengeMode6.this)
                        ...
                        .setPositiveButton("Next", (dialog, which) -> {
                            Intent intent = new Intent(ChallengeMode6.this, Answer_Result.class);
            ...
            public void onFinish() {
                ...
                new Handler().postDelayed(() -> {
                    if (currentIndex < maxQuestions - 1) {
                        ...
                        DatabaseHelper dbHelper = new DatabaseHelper(ChallengeMode6.this);
                        AverageHelper averageHelper = new AverageHelper(ChallengeMode6.this);
                        dbHelper.updateQuizCount("Challenge");
                        averageHelper.updateScore("Challenge", "Muscular System", correctAnswersCount, totalQuestions);
