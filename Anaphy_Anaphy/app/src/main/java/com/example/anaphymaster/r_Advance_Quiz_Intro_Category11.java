...
public class r_Advance_Quiz_Intro_Category11 extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r_practice_quiz_1);
        ...
        // ✅ Corrected: Only one setContentView()
        setContentView(R.layout.r_advance_quiz_intro_chall11);
        ...
        if (takeExamButton != null) {
            ...
            takeExamButton.setOnClickListener(v -> {
                Intent intent = new Intent(r_Advance_Quiz_Intro_Category11.this, AdvanceChallengeMode11.class);
