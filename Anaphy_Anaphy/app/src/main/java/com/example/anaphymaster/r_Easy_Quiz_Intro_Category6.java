...
public class r_Easy_Quiz_Intro_Category6 extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r_easy_quiz_intro_chall6);
        ...
        if (takeExamButton != null) {
            ...
            takeExamButton.setOnClickListener(v -> {
                Intent intent = new Intent(r_Easy_Quiz_Intro_Category6.this, ChallengeMode6.class);
