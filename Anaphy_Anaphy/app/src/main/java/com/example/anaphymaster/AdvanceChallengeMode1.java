...
public class AdvanceChallengeMode1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.advance_challenge_mode1);
        ...
        rationaleIcon.setOnClickListener(v -> {
            if (hasAnswered) {
                ...
                Toast.makeText(AdvanceChallengeMode1.this, "This feature is available after submitting an answer.", Toast.LENGTH_LONG).show();
            }
        });

        restartIcon.setOnClickListener(v -> {
            new AlertDialog.Builder(AdvanceChallengeMode1.this)
            ...
            if (currentIndex < maxQuestions - 1) {
                ...
                new AlertDialog.Builder(AdvanceChallengeMode1.this)
                        ...
                        .setPositiveButton("Next", (dialog, which) -> {
                            Intent intent = new Intent(AdvanceChallengeMode1.this, Answer_Result.class);
                            ...
                            // Add these two lines inside here
            ...
            public void onFinish() {
                ...
                new Handler().postDelayed(() -> {
                    if (currentIndex < maxQuestions - 1) {
                        ...
                        DatabaseHelper dbHelper = new DatabaseHelper(AdvanceChallengeMode1.this);
                        AverageHelper averageHelper = new AverageHelper(AdvanceChallengeMode1.this);
                        dbHelper.updateQuizCount("Challenge");
                        averageHelper.updateScore("Challenge", "Integumentary System", correctAnswersCount, totalQuestions);
