...
public class AdvanceChallengeMode9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.advance_challenge_mode9);
        ...
        rationaleIcon.setOnClickListener(v -> {
            if (hasAnswered) {
                ...
                Toast.makeText(AdvanceChallengeMode9.this, "This feature is available after submitting an answer.", Toast.LENGTH_LONG).show();
            }
        });

        restartIcon.setOnClickListener(v -> {
            new AlertDialog.Builder(AdvanceChallengeMode9.this)
            ...
            if (currentIndex < maxQuestions - 1) {
                ...
                new AlertDialog.Builder(AdvanceChallengeMode9.this)
                        ...
                        .setPositiveButton("Next", (dialog, which) -> {
                            Intent intent = new Intent(AdvanceChallengeMode9.this, Answer_Result.class);
            ...
            public void onFinish() {
                ...
                new Handler().postDelayed(() -> {
                    if (currentIndex < maxQuestions - 1) {
                        ...
                        DatabaseHelper dbHelper = new DatabaseHelper(AdvanceChallengeMode9.this);
                        AverageHelper averageHelper = new AverageHelper(AdvanceChallengeMode9.this);
                        dbHelper.updateQuizCount("Challenge");
                        averageHelper.updateScore("Challenge", "Lymphatic System", correctAnswersCount, totalQuestions);
