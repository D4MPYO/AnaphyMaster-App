    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rationaleIcon.setOnClickListener(v -> {
            if (hasAnswered) {
                ...
                Toast.makeText(Practice_Mode.this, "This feature is available after submitting an answer.", Toast.LENGTH_LONG).show();
            }
        });

        restartIcon.setOnClickListener(v -> {
            new AlertDialog.Builder(Practice_Mode.this)
        ...
        // ---- Added: Next Question Button Logic ----
        nextQuestionButton.setOnClickListener(v -> {
            if (!hasAnswered) {
                Toast.makeText(Practice_Mode.this, "Please answer the question first.", Toast.LENGTH_SHORT).show();
                return;
            }
            if (currentIndex < maxQuestions - 1) {
                ...
                Toast.makeText(Practice_Mode.this, "You have completed the quiz.", Toast.LENGTH_SHORT).show();
            }
        });
    }
