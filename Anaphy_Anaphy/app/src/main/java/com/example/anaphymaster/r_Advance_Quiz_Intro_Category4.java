...
public class r_Advance_Quiz_Intro_Category4 extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r_advance_quiz_intro_chall4);
        ...
        if (takeExamButton != null) {
            ...
            takeExamButton.setOnClickListener(v -> {
                Intent intent = new Intent(r_Advance_Quiz_Intro_Category4.this, AdvanceChallengeMode4.class);
