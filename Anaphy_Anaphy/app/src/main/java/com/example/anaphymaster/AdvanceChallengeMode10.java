...
public class AdvanceChallengeMode10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.advance_challenge_mode10);
        ...
        rationaleIcon.setOnClickListener(v -> {
            if (hasAnswered) {
                ...
                Toast.makeText(AdvanceChallengeMode10.this, "This feature is available after submitting an answer.", Toast.LENGTH_LONG).show();
            }
        });

        restartIcon.setOnClickListener(v -> {
            new AlertDialog.Builder(AdvanceChallengeMode10.this)
            ...
            if (currentIndex < maxQuestions - 1) {
                ...
                new AlertDialog.Builder(AdvanceChallengeMode10.this)
                        ...
                        .setPositiveButton("Next", (dialog, which) -> {
                            Intent intent = new Intent(AdvanceChallengeMode10.this, Answer_Result.class);
                            intent.putExtra("correctAnswers", correctAnswersCount);
                            intent.putExtra("totalQuestions", totalQuestions);
                            dbHelper.updateQuizCount("Challenge");
                            averageHelper.updateScore("Challenge", "Digestive System", correctAnswersCount, totalQuestions);
            ...
            public void onFinish() {
                ...
                new Handler().postDelayed(() -> {
                    if (currentIndex < maxQuestions - 1) {
                        ...
                        DatabaseHelper dbHelper = new DatabaseHelper(AdvanceChallengeMode10.this);
                        AverageHelper averageHelper = new AverageHelper(AdvanceChallengeMode10.this);
                        dbHelper.updateQuizCount("Challenge");
                        averageHelper.updateScore("Challenge", "Digestive System", correctAnswersCount, totalQuestions);
