...
public class r_Easy_Quiz_Intro_Category1 extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r_easy_quiz_intro_chall1);
        ...
        if (takeExamButton != null) {
            ...
            takeExamButton.setOnClickListener(v -> {
                Intent intent = new Intent(r_Easy_Quiz_Intro_Category1.this, ChallengeMode1.class);
