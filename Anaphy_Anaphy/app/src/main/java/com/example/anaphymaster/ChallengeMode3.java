...
public class ChallengeMode3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.challenge_mode3);
        ...
        rationaleIcon.setOnClickListener(v -> {
            if (hasAnswered) {
                ...
                Toast.makeText(ChallengeMode3.this, "This feature is available after submitting an answer.", Toast.LENGTH_LONG).show();
            }
        });

        restartIcon.setOnClickListener(v -> {
            new AlertDialog.Builder(ChallengeMode3.this)
            ...
            if (currentIndex < maxQuestions - 1) {
                ...
                new AlertDialog.Builder(ChallengeMode3.this)
                        ...
                        .setPositiveButton("Next", (dialog, which) -> {
                            Intent intent = new Intent(ChallengeMode3.this, Answer_Result.class);
            ...
            public void onFinish() {
                ...
                new Handler().postDelayed(() -> {
                    if (currentIndex < maxQuestions - 1) {
                        ...
                        DatabaseHelper dbHelper = new DatabaseHelper(ChallengeMode3.this);
                        AverageHelper averageHelper = new AverageHelper(ChallengeMode3.this);
                        dbHelper.updateQuizCount("Challenge");
                        averageHelper.updateScore("Challenge", "Skeletal System", correctAnswersCount, totalQuestions);
