    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rationaleIcon.setOnClickListener(v -> {
            if (hasAnswered) {
                ...
                Toast.makeText(Prac_9_Lymphatic.this, "This feature is available after submitting an answer.", Toast.LENGTH_LONG).show();
            }
        });

        restartIcon.setOnClickListener(v -> {
            new AlertDialog.Builder(Prac_9_Lymphatic.this)
            ...
            if (currentIndex < maxQuestions - 1) {
                ...
                new AlertDialog.Builder(Prac_9_Lymphatic.this)
                        ...
                        .setPositiveButton("Next", (dialog, which) -> {
                            Intent intent = new Intent(Prac_9_Lymphatic.this, Answer_Result.class);
