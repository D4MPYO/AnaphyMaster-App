    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rationaleIcon.setOnClickListener(v -> {
            if (hasAnswered) {
                ...
                Toast.makeText(ChallengeMode10.this, "This feature is available after submitting an answer.", Toast.LENGTH_LONG).show();
            }
        });

        restartIcon.setOnClickListener(v -> {
            new AlertDialog.Builder(ChallengeMode10.this)
            ...
            if (currentIndex < maxQuestions - 1) {
                ...
                new AlertDialog.Builder(ChallengeMode10.this)
                        ...
                        .setPositiveButton("Next", (dialog, which) -> {
                            Intent intent = new Intent(ChallengeMode10.this, Answer_Result.class);
            ...
            public void onFinish() {
                ...
                new Handler().postDelayed(() -> {
                    if (currentIndex < maxQuestions - 1) {
                        ...
                        DatabaseHelper dbHelper = new DatabaseHelper(ChallengeMode10.this);
