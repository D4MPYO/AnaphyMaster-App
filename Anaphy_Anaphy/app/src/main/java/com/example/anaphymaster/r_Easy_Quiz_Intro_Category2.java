...
public class r_Easy_Quiz_Intro_Category2 extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r_easy_quiz_intro_chall2);
        ...
        if (takeExamButton != null) {
            ...
            takeExamButton.setOnClickListener(v -> {
                Intent intent = new Intent(r_Easy_Quiz_Intro_Category2.this, ChallengeMode2.class);
